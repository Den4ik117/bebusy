<template>
    ...
    <template v-else>
        ...
        <div class="flex gap-2 items-end shadow-md flex-row">
            <div class="w-8 h-8 flex-none rounded-full bg-amber-500"></div>
            <div class="rounded-md p-2 text-sm whitespace-pre-wrap bg-[#212121] w-full">
